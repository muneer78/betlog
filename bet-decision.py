...
user_choice = input(
    "Enter 'F' for Favorite or 'U' for Underdog: ").strip().upper()

# Do closest match for point spread
nearest_point_spread = df.iloc[(
    df['Point Spread'] - user_point_spread).abs().idxmin()]
