...
df['ExpectedValue'] = np.ceil(df['ImpliedProbability'] * df['Amount']) - ((1 - df['ImpliedProbability']) * df['Amount'])
...
currency_columns = ['Amount', 'PotentialProfit', 'PotentialPayout', 'ExpectedValue', 'ActualPayout']
