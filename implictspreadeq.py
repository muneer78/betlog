...
implicit_spread_interp = interp1d(df['Bet Price'], df['Implicit Spread'], kind='linear', fill_value="extrapolate")
...
print(f"Implicit Spread for Posted Spread {posted_spread} and Bet Price {bet_price}: {implicit_spread}")
