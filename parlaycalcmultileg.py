...
# Function to calculate odds needed to reach a target parlay of 2 (equivalent to +100 in American odds)
...
# Check if the total decimal odds are already above 2.0 (equivalent to +100 in American odds)
if total_decimal_odds >= 2.0:
    print("This parlay is already above +100 in American odds")
else:
    # Calculate the odds needed for the next leg to make the parlay reach 2.0 in decimal odds
    ...
    print(f"To achieve a parlay odds of +100 with the current legs and a new leg, the next leg needs to have American odds of {required_odds_american:+d}")
